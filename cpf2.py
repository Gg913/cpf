...
def consultar_cpf(update, context):
    ...
    headers = {
        'sec-ch-ua': '"Not.A/Brand";v="99", "Chromium";v="90", "Opera";v="100"',
        'Accept': 'application/json, text/plain, */*',
        'Referer': 'https://servicos.cloud.saude.gov.br/pni/cpf/',
        'Accept-Language': 'en-US,en;q=0.9',
        'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.._0xh59bU7IyQEiMlxtCoWfHHCGM5JMTf1dbYchrZXx8',
        'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.212 Safari/537.36',
        'Origin': 'https://servicos.cloud.saude.gov.br',
        'Connection': 'keep-alive',
        'Referer': 'https://servicos.cloud.saude.gov.br/',
